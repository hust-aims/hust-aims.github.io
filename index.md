...
<body>
    ...
    <div id="divout">
        ...
        <div class="imgdiv">
            <img src="/assets/img/Civet2040.jpg" height="80%" width="80%" alt="">
            <div class="title">Civet 2040 Award</div>
        </div>
        <div class="imgdiv">
            <img src="/assets/img/Postdoctoral_Competition.jpg" height="80%" width="80%" alt="">
