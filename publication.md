...
- **[DATE]** **[Improving the energy efficiency of STT-MRAM based approximate cache](http://thiszw.top/paper/appcache.pdf)** in Proceedings of Design, Automation and Test in Europe Conference (DATE), 2021.
...
- **[ICCAD]** **[Aliens: A Novel Hybrid Architecture for Resistive Random-Access Memory](https://dl.acm.org/doi/abs/10.1145/3240765.3240776)** is accepted by Proceedings of the International Conference on Computer-Aided Design (ICCAD), 2018.
  <br/>Bing Wu, Dan Feng, Wei Tong, Jingning Liu, Shuai Li, Mingshun Yang, Chengning Wang, Yang Zhang.
- **[DATE]** **[Extending the lifetime of NVMs with compression](https://ieeexplore.ieee.org/abstract/document/8342271)** is accepted by Design, Automation & Test in Europe Conference & Exhibition (DATE) 2018
  <br/>Jie Xu, Dan Feng, Yu Hua, Wei Tong, Jingning Liu, Chunyan Li.
- **[DATE]** **[An efficient PCM-based main memory system via exploiting fine-grained dirtiness of cachelines](https://ieeexplore.ieee.org/abstract/document/8342273)** is accepted by Design, Automation & Test in Europe Conference & Exhibition (DATE), 2018.
...
- **[DATE]** **[Mapping granularity adaptive FTL based on flash page re-programming](https://ieeexplore.ieee.org/abstract/document/7927019)** is accepted by Design, Automation & Test in Europe Conference & Exhibition (DATE), 2017.
  <br/>Yazhi Feng, Dan Feng, Chenye Yu, Wei Tong, Jingning Liu.
...
- **[ICPP]** **[Tetris Write: Exploring More Write Parallelism Considering PCM Asymmetries](https://ieeexplore.ieee.org/abstract/document/7573814)** is accepted by International Conference on Parallel Processing (ICPP), 2016
  <br/>Zheng Li, Fang Wang, Dan Feng, Yu Hua, Wei Tong, Jingning Liu, Xiang Liu.
- **[DATE]** **[Exploiting more parallelism from write operations on PCM](https://ieeexplore.ieee.org/abstract/document/7459410)** is accepted by Design, Automation & Test in Europe Conference & Exhibition (DATE), 2016
...
- **[TACO]** **[ICON-NIV: A Generalized Method for Mitigating the Impacts of IR Drop and Nonlinear I-V Effect in eNVM-based Accelerators](https://dl.acm.org/doi/full/10.1145/3777381)** is accepted by ACM Transactions on Architecture and Code Optimization (TACO), 2025.
...
- **[TCAD]** **[Multiple Subpage Writing FTL in MLC by Exploiting Dual Mode Operations](https://ieeexplore.ieee.org/abstract/document/8599050)** is accepted by Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD), 2019. 
